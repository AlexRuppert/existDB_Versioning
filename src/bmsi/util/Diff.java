/*
 * $Log: Diff.java,v $
 * Revision 1.1  2013/11/04 02:04:04  ruppert
 * initial commit
 *
 * EXist has a severe Bug for versioning: Only the base is taken for DIffs, but to restore a Document, all Diffs are accumulated
 *
 * This patch circumvents the problem with a temporary file, which stores the previos state of the document and used instead of the base file.
 *
 * Didn't get it to work for eXist directly, simply compile and then replace the original VersioningTrigger.java in the eXist exist-versioning.jar
 *
